  ...
  return (
    <section className="py-12 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4">
        <p className="text-[#C9A055] text-xs uppercase tracking-[4px] mb-3">Knowledge Hub</p>
        <h1 className="text-3xl font-light mb-3">Real Estate Blog</h1>
        <p className="text-gray-500 mb-10">{blogs.length} articles on Bangalore property market</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sorted.map((b: any) => (
            <Link href={`/blog/${b.slug}/`} key={b.id} className="group bg-[#111] border border-[#222] hover:border-[#C9A055]/30 transition p-6">
              ...
              <h2 className="font-medium mt-2 mb-3 group-hover:text-[#C9A055] transition line-clamp-2">{b.title}</h2>
